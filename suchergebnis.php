...
<html>
    ...
    <body>
        ...
        $sql_lampen = "SELECT * FROM produkt WHERE * LIKE "'%" . $_GET["lastname"] . "%'";
		
        echo $sql_lampen;
        $result_lampen = $mysqli->query($sql_lampen);
    
        $db_erg_lampen = mysqli_query($mysqli, $sql_lampen);
            ...
            <?php
                echo '<table border="1">';
                    echo "<tr>";
                        ...
                        echo "<th>Preis</th>";
                    echo "</tr>";
                while ($row = mysqli_fetch_array($db_erg_lampen, MYSQL_ASSOC))
                {
                    echo "<tr>";
